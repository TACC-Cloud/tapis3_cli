...
class FileArg(ParserExtender):
    ...
    def add_file_arg(
        self, parser, name="File", destination="file_arg", metavar=None, optional=True
    ):
    ...
    def get_file_data(
        self, parsed_args, destination="file_arg", validate=False, permissive=False
    ):
...
class JSONArg(ParserExtender):
    ...
    def get_file_data(
        self, parsed_args, destination="json_arg", validate=False, permissive=False
    ):
        file_descriptor = getattr(parsed_args, destination)
